...
final readonly class ResourceRelationRecordsController
{
    public function __construct(
        private ResourceRelationRecordsDataSource $dataSource,
    ...
    public function __invoke(\Illuminate\Http\Request $request, string $relation): \Illuminate\Http\JsonResponse
    {
        ...
        try {
            ...
            logger()->warning('Relation manager records request was rejected.', [
            ...
            logger()->error('Relation manager records request failed.', [
                'resource' => $resourceClass,
                'relation' => $relation,
                'action' => 'records',
                'exception' => $e::class,
